...
* `DATABASE_NAME`: Name of the database in [mongoDB](https://www.mongodb.com). For more help watch this [video]([https://youtu.be/1G1XwEOnxxo](https://github.com/MrMKN/PROFESSOR-BOT))
