    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            k = await message.reply(
                text='<b>CHAT NOT ALLOWED 🐞\n\n𝖬𝗒 𝖠𝖽𝗆𝗂𝗇𝗌 𝗁𝖺𝗌 𝖱𝖾𝗌𝗍𝗋𝗂𝖼𝗍𝖾𝖽 𝗆𝖾 𝖿𝗋𝗈𝗆 𝗐𝗈𝗋𝗄𝗂𝗇𝗀 𝗁𝖾𝗋𝖾! 𝖨𝖿 𝗒𝗈𝗎 𝗐𝖺𝗇𝗍 𝗍𝗈 𝗄𝗇𝗈𝗐 𝖼𝗈𝗇𝗍𝖺𝖼𝗍 𝖮𝗐𝗇𝖾𝗋...</b>',
        ...
        await message.reply_text(
            text=f"<b>>> 𝖳𝗁𝖺𝗇𝗄𝗌 𝗍𝗈 𝖠𝖽𝖽 𝖬𝖾 𝖳𝗈 𝖸𝗈𝗎𝗋 𝖦𝗋𝗈𝗎𝗉 ♡.\n›› 𝖣𝗈𝗇'𝗍 𝖥𝗈𝗋𝗀𝖾𝗍 𝗍𝗈 𝖬𝖾𝗄𝖾 𝗆𝖾 𝖠𝖽𝗆𝗂𝗇.\n›› 𝖨𝗌 𝖺𝗇𝗒 𝖣𝗈𝗎𝖻𝗍𝗌 𝖺𝖻𝗈𝗎𝗍 𝗎𝗌𝗂𝗇𝗀 𝗆𝖾 𝖼𝗅𝗂𝖼𝗄 𝖻𝖾𝗅𝗈𝗐 𝖡𝗎𝗍𝗍𝗈𝗇..⚡⚡.</b>",
            reply_markup=reply_markup)
    else:
