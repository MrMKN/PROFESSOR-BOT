...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ 🔈", url="https://t.me/onlyhdmoviesre")
            ],[      
            InlineKeyboardButton("🙆 Hᴇʟᴩ 🦾", callback_data="help"),
            InlineKeyboardButton("💓 Aʙᴏᴜᴛ 💓", callback_data="about")
        ],[      
            InlineKeyboardButton("Bollywood 📽️", url="https://t.me/radheradhe765"),
            InlineKeyboardButton("Hollywood 🍿", url="https://t.me/radheradhe765"),
            InlineKeyboardButton("Tollywood 🎬", url"https://t.me/radheradhe765")
        ]]
