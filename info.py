...
SPELL_CHECK_REPLY = is_enabled(environ.get('CHECK_SPELL', 'താങ്കൾ ആവശ്യപ്പെട്ട സീരീസ് ലഭ്യമാവുകയാണെങ്കിൽ ഞങ്ങൾ അപ്‌ലോഡ് ചെയ്യുന്നതായിരിക്കും ദയവായി ഞങ്ങൾ അപ്‌ലോഡ് ചെയ്യുന്നത് വരെ കാത്തിരിക്കുക അപ്‌ലോഡ് ചെയ്ത ശേഷം ഞങ്ങൾ അറിയിക്കുന്നതാണ്.')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/TEAM_COLD')
