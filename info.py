...
API_ID = int(environ('API_ID','9573300'))
API_HASH = environ('API_HASH','eaa2cf1d5cbf6dc81da2d85a76a335a5')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', 'https://t.me/+QJ0zdNuBAh5lNWI9').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://brokenboy:brokenboy204@cluster0.mwysc4u.mongodb.net/?retryWrites=true&w=majority")
